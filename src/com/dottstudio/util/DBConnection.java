    ...
    static {
        try {
            ...
            if (databaseUrl != null && !databaseUrl.isEmpty()) {
                ...
                System.out.println(">>> Using Heroku DATABASE_URL");
                ...
                System.out.println(">>> Connected to Heroku Postgres: " + host);
            } else {
                // Local development fallback
                System.out.println(">>> Using localhost PostgreSQL (local development)");
            ...
            System.err.println(">>> DRIVER LOADING FAILED! PostgreSQL JDBC driver is missing.");
            e.printStackTrace();
            throw new RuntimeException("CRITICAL ERROR: Failed to load PostgreSQL JDBC Driver!", e);
        } catch (URISyntaxException e) {
            System.err.println(">>> DATABASE_URL parsing failed! Using localhost fallback.");
            e.printStackTrace();
